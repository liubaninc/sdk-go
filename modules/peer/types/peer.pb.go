...
func init() {
	proto.RegisterType((*Peer)(nil), "liubaninc.m1.peer.Peer")
}
...
var fileDescriptor_c302117fbb08ad42 = []byte{
	...
	0x79, 0x99, 0x79, 0xc9, 0x7a, 0xb9, 0x86, 0x7a, 0x20, 0x09, 0x29, 0x91, 0xf4, 0xfc, 0xf4, 0x7c,
	0xb0, 0xac, 0x3e, 0x88, 0x05, 0x51, 0xa8, 0x94, 0xc2, 0xc5, 0x12, 0x90, 0x9a, 0x5a, 0x24, 0x24,
	...
	0x1c, 0x21, 0x21, 0x2e, 0x96, 0xc4, 0x94, 0x94, 0x22, 0x09, 0x66, 0xb0, 0x20, 0x98, 0x0d, 0x32,
	0x23, 0x37, 0x3f, 0x2f, 0x33, 0x3b, 0xb5, 0x48, 0x82, 0x05, 0x62, 0x06, 0x94, 0xeb, 0xe4, 0x71,
	...
	0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0x70, 0x37, 0xeb, 0x17, 0xa7, 0x64, 0xeb, 0xa6, 0xe7, 0xeb,
	0xe7, 0xe6, 0xa7, 0x94, 0xe6, 0xa4, 0x16, 0x83, 0x3d, 0xa6, 0x5f, 0x52, 0x59, 0x90, 0x5a, 0x9c,
	0xc4, 0x06, 0x76, 0xb6, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x5f, 0xe0, 0xf3, 0x7a, 0xf2, 0x00,
	0x00, 0x00,
}
...
func (m *Peer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Moniker) > 0 {
		...
		i = encodeVarintPeer(dAtA, i, uint64(len(m.Moniker)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Addr) > 0 {
	...
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintPeer(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
		...
		i = encodeVarintPeer(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0xa
	}
